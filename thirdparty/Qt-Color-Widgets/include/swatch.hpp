...
class Swatch : public QWidget {
   ...
   */
  Q_PROPERTY(const ColorPalette& palette READ palette WRITE setPalette NOTIFY
                 paletteChanged)
  /**
   * \brief Currently selected color (-1 if no color is selected)
   */
  Q_PROPERTY(
      int selected READ selected WRITE setSelected NOTIFY selectedChanged)

  /**
   * \brief Preferred size for a color square
   */
  Q_PROPERTY(
      QSize colorSize READ colorSize WRITE setColorSize NOTIFY colorSizeChanged)

  Q_PROPERTY(ColorSizePolicy colorSizePolicy READ colorSizePolicy WRITE
                 setColorSizePolicy NOTIFY colorSizePolicyChanged)
   ...
   */
  Q_PROPERTY(int forcedRows READ forcedRows WRITE setForcedRows NOTIFY
                 forcedRowsChanged)
   ...
   */
  Q_PROPERTY(int forcedColumns READ forcedColumns WRITE setForcedColumns NOTIFY
...
protected Q_SLOTS:
  /**
   * \brief Connected to the internal palette object to keep eveything
   * consistent
   */
