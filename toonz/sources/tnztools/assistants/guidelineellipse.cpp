...
TGuidelineEllipse::TGuidelineEllipse(bool enabled, double magnetism,
                                     TAffine matrix)
    : TGuideline(enabled, magnetism), matrix(matrix), matrixInv(matrix.inv()) {}

TGuidelineEllipse::TGuidelineEllipse(bool enabled, double magnetism,
                                     TAffine matrix, TAffine matrixInv)
    : TGuideline(enabled, magnetism), matrix(matrix), matrixInv(matrixInv) {}
...
int TGuidelineEllipse::calcSegmentsCount(const TAffine &ellipseMatrix,
  ...
  return segments <= (double)min ? min : segments >= (double)max
                                             ? max
                                             : (int)segments;
}
