...
bool Swatch_Plugin::isInitialized() const { return initialized; }
...
QString Swatch_Plugin::name() const { return "color_widgets::Swatch"; }

QString Swatch_Plugin::group() const { return "Color Widgets"; }
...
QString Swatch_Plugin::whatsThis() const { return toolTip(); }

bool Swatch_Plugin::isContainer() const { return false; }
...
QString Swatch_Plugin::includeFile() const { return "swatch.hpp"; }
