...
bool ColorPaletteWidget_Plugin::isInitialized() const { return initialized; }

QWidget *ColorPaletteWidget_Plugin::createWidget(QWidget *parent) {
  color_widgets::ColorPaletteWidget *wid =
      new color_widgets::ColorPaletteWidget(parent);
  ...
  color_widgets::ColorPaletteModel *model =
      new color_widgets::ColorPaletteModel;
  model->setParent(wid);
...
QString ColorPaletteWidget_Plugin::group() const { return "Color Widgets"; }
...
QString ColorPaletteWidget_Plugin::whatsThis() const { return toolTip(); }

bool ColorPaletteWidget_Plugin::isContainer() const { return false; }

QString ColorPaletteWidget_Plugin::domXml() const {
  return "<ui language=\"c++\">\n"
         " <widget class=\"color_widgets::ColorPaletteWidget\" "
         "name=\"palette_widget\">\n"
         " </widget>\n"
         "</ui>\n";
}
