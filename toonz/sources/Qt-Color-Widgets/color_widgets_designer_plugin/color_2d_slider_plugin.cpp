...
bool Color2DSlider_Plugin::isInitialized() const { return initialized; }
...
QString Color2DSlider_Plugin::group() const { return "Color Widgets"; }
...
QString Color2DSlider_Plugin::whatsThis() const { return toolTip(); }

bool Color2DSlider_Plugin::isContainer() const { return false; }
