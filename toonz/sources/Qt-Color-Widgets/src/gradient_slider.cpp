...
GradientSlider::~GradientSlider() { delete p; }
...
QBrush GradientSlider::background() const { return p->back; }
...
QGradientStops GradientSlider::colors() const { return p->gradient.stops(); }
...
QLinearGradient GradientSlider::gradient() const { return p->gradient; }
