...
class QCP_EXPORT ColorWheel : public QWidget {
  ...
  Q_PROPERTY(QColor color READ color WRITE setColor NOTIFY colorChanged
                 DESIGNABLE true STORED false)
  Q_PROPERTY(qreal hue READ hue WRITE setHue DESIGNABLE false)
  Q_PROPERTY(
      qreal saturation READ saturation WRITE setSaturation DESIGNABLE false)
  ...
  Q_PROPERTY(DisplayFlags displayFlags READ displayFlags WRITE setDisplayFlags
                 NOTIFY displayFlagsChanged DESIGNABLE true)
...
public:
   ...
   * @param relative_to  Index of other harmony that should be symmetric
   * relative to main hue
   * @returns Index of newly added harmony
...
Q_SIGNALS:
  ...
  /**
   * Emitted when harmony settings or harmony colors are changed (including due
   * to main hue change)
   */
  void harmonyChanged();
