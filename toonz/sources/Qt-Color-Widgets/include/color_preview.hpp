...
class QCP_EXPORT ColorPreview : public QWidget {
  ...
  Q_PROPERTY(QColor color READ color WRITE setColor NOTIFY colorChanged
                 DESIGNABLE true)
  Q_PROPERTY(QColor comparisonColor READ comparisonColor WRITE
                 setComparisonColor DESIGNABLE true)
  Q_PROPERTY(DisplayMode display_mode READ displayMode WRITE setDisplayMode
                 DESIGNABLE true)
  Q_PROPERTY(
      QBrush background READ background WRITE setBackground DESIGNABLE true)
  Q_ENUMS(DisplayMode)
public:
  enum DisplayMode {
