...
class ColorPaletteWidget : public QWidget {
   ...
   */
  Q_PROPERTY(
      ColorPaletteModel* model READ model WRITE setModel NOTIFY modelChanged)
   ...
   **/
  Q_PROPERTY(color_widgets::Swatch::ColorSizePolicy colorSizePolicy READ
                 colorSizePolicy WRITE setColorSizePolicy NOTIFY
   ...
   */
  Q_PROPERTY(QColor currentColor READ currentColor WRITE setCurrentColor NOTIFY
                 currentColorChanged)
