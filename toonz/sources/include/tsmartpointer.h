...
public:
  ...
  TSmartHolderT &operator=(const TSmartHolderT &src) {
    set(src);
    return *this;
  }
  ...
  void set(const TSmartHolderT &src) { set(src.m_pointer); }
  void reset() { set(0); }
...
public:
  ...
  TSmartPointerConstT &operator=(const TSmartPointerConstT &src) {
    Holder::set(src);
    return *this;
  }
